...
if page == "Program":
    ...
    st.markdown(
        ...
        <div class="centered-logo">
            <img src="https://raw.githubusercontent.com/AJ-Clark83/KLAC/refs/heads/main/kingsway.jpg" alt="Kingsway Logo" width="250">
        </div>
        """,
    ...
    display_df['Group'] = display_df['Group'].str.replace(' ', '')
    ...
    num_chunks = len(chunks)  # Ensure num_chunks is calculated with each new data load
    ...
    # Fetch and display live announcement if available
